...
async def choose_give_keyboards():
    choose_keyboard_give = InlineKeyboardMarkup(
        inline_keyboard=[
        [
            InlineKeyboardButton(text='⏫ Melbet', callback_data=choose_buttons.new(action='melbet_give')),
            InlineKeyboardButton(text='⏫ Betmoon', callback_data=choose_buttons.new(action='betmoon_give')),
        ],
        [
            InlineKeyboardButton(text='⏫ Linebet', callback_data=choose_buttons.new(action='linebet_give')),
            InlineKeyboardButton(text='⏫ 1xbet', callback_data=choose_buttons.new(action='1xbet_give')),
        ],
        [
