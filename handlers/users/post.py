...
from keyboards.default.main_menu import AdminMain_menu
from loader import dp, db
from states.almashish_state import sendPost

@dp.message_handler(IsPrivate(), chat_id=ADMINS[0] , text=['Sendpost'])
...
async def quit_menu(call: types.ContentTypes, state: FSMContext):
    await state.finish()
    await call.message.answer("Tizim yuborishni bekor qildi!", reply_markup=AdminMain_menu)
